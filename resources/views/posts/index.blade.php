                    ...
                    <table class="border-collapse table-auto w-full text-sm">
                        <thead>
                            <tr>
                                ...
                                <th class="border-b font-medium p-4 pl-8 pt-0 pb-3 text-slate-400 text-left">content</th>
                        ...
                        <tbody class="bg-white">
                            @foreach ($posts as $post)
                                <tr>
                                    ...
                                    <td class="border-b border-slate-100 dark:border-slate-700 p-4 pl-8 text-slate-500 dark:text-slate-400">{{ $post->content }}</td>
